wc.blocksCheckout.registerCheckoutBlock({
	metadata: {
		...
		"apiVersion": 3,
		"name": "eascompliance/eascompliance-calculate-taxes-minicart",
		"version": "1.0.0",
	...
	component: (props) => {
		// TODO Why is this code not called?

		const $ = window.jQuery
		const E = wp.element.createElement
		const { plugin_dictionary } = wc.wcSettings.getSetting('eascompliance-minicart-integration_data')
