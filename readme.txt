...
* EAS EU compliance fully supports WooCommerce blocks-based cart and checkout pages
...
* Improved debug data collection performance.

= 1.8.13 =
* Issue with activating plugin with WC-CLI fixed
...
* Minor bugs with WooCommerce subscription plugin compatibility fixed 
* Refunds handling process enhanced and rounding issues fixed
* Some UI bugs fixed
